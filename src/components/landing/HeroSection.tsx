    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="font-rounded font-black text-5xl md:text-7xl lg:text-9xl mb-8 pt-16 leading-tight bg-gradient-avvy bg-clip-text text-transparent drop-shadow-none" style={{WebkitTextStroke: '1px black'}}>
